...
class OneCoursePageHeader extends Component{
    ...
    componentDidMount() {
        this.props.dispatch(studyAction.getOneCourse('Linux'));
    }
    ...
    render() {
        const oneCourse = this.props.oneCourse;
            ...
            return (
                ...
                <section id="one-course-header" className='bg-linux' >
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-4 align-right">
                                    <div className="card shadow one-course-header-my-card h-100 bg-linux-priceCard">
